				...
				options: [
					{
						...
						values: [
							{
								displayName:
									'These meta fields must be exposed in WordPress REST API. Use <code>register_post_meta()</code> in functions.php or a plugin to enable writing. <a href="https://github.com/haunchen/n8n-nodes-wordpress/blob/main/docs/yoast-seo-setup.md" target="_blank">Learn more</a>',
								name: 'notice',
								type: 'notice',
								default: '',
							},
